...
Zivotno::Zivotno(char *Kime, char Kpol, 
...
//ovaa mislam deka mi e vishok dole go pravam istoto 
...
// }
int Zivotno:: presmetajVakcinacija()//kolku dena pominale od denot na vakcinacija do denes
{
   time_t now = time(0);
